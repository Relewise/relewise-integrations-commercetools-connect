...
describe('mapProduct', () => {
  it('should map product properties correctly', () => {
    ...
    const result = mapProduct(
      product as unknown as ProductProjection,
      unixTimeStamp,
      categoriesMap
    );
    ...
    const variants: CTProductVariant[] = [
      {
        ...
        prices: [
          {
            country: 'us',
            value: { centAmount: 100000, currencyCode: 'USD' },
          } as unknown as Price,
          {
            country: 'us',
            value: { centAmount: 90000, currencyCode: 'USD' },
          } as unknown as Price,
          {
            country: 'nl',
            value: { centAmount: 80000, currencyCode: 'EUR' },
          } as unknown as Price,
        ],
      },
      {
        ...
        prices: [
          ...
          {
            country: 'nl',
            value: { centAmount: 75000, currencyCode: 'EUR' },
          } as unknown as Price,
        ],
      },
    ];
...
describe('mapVariants', () => {
  it('should map variants correctly', () => {
    ...
    // Call the function to test
    const result = mapVariants(
      variants as CTProductVariant[],
      product as unknown as ProductProjection
    );
